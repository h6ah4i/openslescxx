...
#ifndef OPENSLESCXX_CSL_BASS_BOOST_ITF_HPP_
#define OPENSLESCXX_CSL_BASS_BOOST_ITF_HPP_
...
//
class CSLBassBoostItf : public CSLInterface {
public:
    DECL_CSL_INTERFACE_OPERATORS(CSLBassBoostItf, SLBassBoostItf)

    static const SLInterfaceID sGetIID() noexcept { return SL_IID_BASSBOOST; }

    CSLBassBoostItf() : CSLInterface(sGetIID()) {}
    virtual ~CSLBassBoostItf() {}
...
#endif // OPENSLESCXX_CSL_BASS_BOOST_ITF_HPP_
